...
class InputExample(object):
    ...
    """
    def __init__(self, example_id, words, pos_list, labels=None, target_verbs=None):
        self.example_id = example_id
        self.words = words
        self.pos_list = pos_list
        self.labels = labels
        self.targets_verbs = target_verbs
...
class InputFeatures(object):
    ...
    """
    def __init__(self, input_ids, input_mask, segment_ids, pos_ids, label_ids=None, target_verb_ids=None):
        self.input_ids = input_ids
        self.input_mask = input_mask
        self.segment_ids = segment_ids
        self.pos_ids = pos_ids
        self.label_ids = label_ids
        self.target_verb_ids = target_verb_ids
